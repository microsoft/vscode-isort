...
def test_document_with_no_path_falls_back_to_workspace():
    ...
    mock_lsp_types = types.ModuleType("lsprotocol.types")
    for _name in [
        ...
        setattr(mock_lsp_types, _name, _name)
    for _name in [
        ...
        "CodeAction", "CodeActionKind", "CodeActionParams", "OptionalVersionedTextDocumentIdentifier",
        "TextDocumentEdit", "WorkspaceEdit",
    ]:
        setattr(mock_lsp_types, _name, type(_name, (), {}))
    mock_lsp_types.MessageType = type("MessageType", (), {"Log": 4, "Error": 1, "Warning": 2, "Info": 3})
